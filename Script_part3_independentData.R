...
plot(hdgCh$resistance, hdgCh$w.resilience, xlab = "Change in state", ylab = "w.Resilience", bg = hdgCh$clust, pch = 21, type = "b", cex = sqrt(hdgCh$maxMag))
	plot(hdgCh$recovery, hdgCh$resilience, xlab = "Recovery", ylab = "Resilience", bg = hdgCh$clust, pch = 21, type = "b", cex = sqrt(hdgCh$maxMag))
	plot(hdgCh$recovery, hdgCh$w.resilience, xlab = "Recovery", ylab = "w.Resilience", bg = hdgCh$clust, pch = 21, type = "b", cex = sqrt(hdgCh$maxMag))
